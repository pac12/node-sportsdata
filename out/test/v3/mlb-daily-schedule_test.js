  ...
  describe('V3 MLB', function() {
    ...
    return describe('#getDailySchedule()', function() {
      ...
      it('should pass error and no result with bad api key', function(done) {
        return badMlb.getDailySchedule(new Date('2013-05-10 00:00:00'), function(err, result) {
      ...
      it('should pass no error and schedule as result on 200', function(done) {
        return mlb.getDailySchedule(new Date('2013-05-10 00:00:00'), function(err, result) {
          should.not.exist(err);
          result.should.be.a('object');
      ...
      it('should support date object literal param', function(done) {
        ...
        return mlb.getDailySchedule(params, function(err, result) {
          should.not.exist(err);
          result.should.be.a('object');
          result.calendars.should.be.a('object');
          result.calendars.event.should.be.an.instanceOf(Array);
      ...
      it('should support string param', function(done) {
        return mlb.getDailySchedule('2013-05-10 00:00:00', function(err, result) {
          should.not.exist(err);
          result.should.be.a('object');
          result.calendars.should.be.a('object');
          result.calendars.event.should.be.an.instanceOf(Array);
      ...
      it('should pass no error and empty schedule as result on 200 and no schedule', function(done) {
        return mlb.getDailySchedule(new Date('2013-07-15 00:00:00'), function(err, result) {
          should.not.exist(err);
          result.should.be.a('object');
          result.calendars.should.be.a('object');
