(function() {
  ...
  describe('V3 MLB', function() {
    ...
    return describe('#getEventBoxscore()', function() {
      var scope;
      scope = void 0;
      before(function() {
        return scope = nock('http://api.sportsdatallc.org').get('/mlb-t3/boxscore/c8457f5d-d8ed-4949-8c92-b341e5b37fa4.xml?api_key=bad-key').replyWithFile(403, __dirname + '/replies/api-key-error.txt').get('/mlb-t3/boxscore/bad-event-id.xml?api_key=api-key').replyWithFile(412, __dirname + '/replies/event-id-error.txt').get('/mlb-t3/boxscore/c8457f5d-d8ed-4949-8c92-b341e5b37fa4.xml?api_key=api-key').replyWithFile(200, __dirname + '/replies/event-boxscore-200.txt').get('/mlb-t3/boxscore/c8457f5d-d8ed-4949-8c92-b341e5b37fa4.xml?api_key=api-key').replyWithFile(200, __dirname + '/replies/event-boxscore-200.txt');
      });
      it('should be a function', function() {
        return mlb.getEventBoxscore.should.be.a('function');
      });
      it('should should throw error without eventId', function() {
        return (function() {
          return mlb.getEventBoxscore();
        }).should.throwError(/required/);
      });
      it('should pass error and no result with bad api key', function(done) {
        return badMlb.getEventBoxscore('c8457f5d-d8ed-4949-8c92-b341e5b37fa4', function(err, result) {
      ...
      it('should pass error and no result with bad eventId', function(done) {
        return mlb.getEventBoxscore('bad-event-id', function(err, result) {
      ...
      it('should pass no error and teams as result on 200', function(done) {
        return mlb.getEventBoxscore('c8457f5d-d8ed-4949-8c92-b341e5b37fa4', function(err, result) {
      ...
      it('should support object literal as param', function(done) {
        ...
        return mlb.getEventBoxscore(params, function(err, result) {
          should.not.exist(err);
          result.should.be.a('object');
          result.boxscore.should.be.a('object');
          result.boxscore.final.should.be.a('object');
